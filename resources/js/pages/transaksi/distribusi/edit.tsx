...
import { type Pelanggan, type Barang, type Distribusi, type BreadcrumbItem, type JenisKendaraan } from '@/types';
...
export default function DistribusiEdit({ distribusi, pelanggans, barangs }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/distribusi/${distribusi.id}/edit` },
    ];

    const { data, setData, put, processing, errors } = useForm({
        faktur_distribusi: distribusi.faktur_distribusi,
        pelanggan_id: distribusi.pelanggan_id.toString(),
        barang_id: distribusi.barang_id.toString(),
        tanggal: distribusi.tanggal,
        jarak_kirim_km: distribusi.jarak_kirim_km.toString(),
        jumlah_kg: distribusi.jumlah_kg.toString(),
        jenis_kendaraan: distribusi.jenis_kendaraan,
        biaya_bahan_bakar: distribusi.biaya_bahan_bakar.toString(),
        biaya_tenaga_kerja: distribusi.biaya_tenaga_kerja.toString(),
        biaya_tambahan: distribusi.biaya_tambahan.toString(),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/distribusi/${distribusi.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Distribusi ${distribusi.tanggal}`} />
            ...
            <div className="flex flex-col gap-4 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Edit Distribusi</h1>
                        <p className="text-muted-foreground">
                            Edit data distribusi tanggal {distribusi.tanggal}
                        </p>
                    </div>
                </div>
