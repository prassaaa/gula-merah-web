...
import { type Barang, type Pelanggan, type BreadcrumbItem } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah', href: '/penjualan/create' },
];

export default function PenjualanCreate({ barangs, pelanggans }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">Tambah Penjualan</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.barang_id} onValueChange={handleBarangChange}>
                                        <SelectTrigger>
